defmodule SlaxWeb.ChatRoomLive do
          ...
          <div id="rooms-list">
            ...
            <div class="relative">
              ...
              <div
                ...
                class="hidden cursor-default absolute top-8 right-2 bg-white border-slate-200 py-3 rounded-lg"
  ...
  # JS.toggle tells the browser to run that javascript code, in this case on click
  # It will toggle the html elements with those ids in the to: section
  ...
  def mount(_params, _session, socket) do
    ...
    # Tell Presence that our current process/user needs to be tracked
    # When the process is alive, the user will be online.
    # When the process is killed, the user will turn offline
    ...
    socket =
      ...
      |> stream_configure(:messages,
        dom_id: fn
          ...
          :unread_marker -> "messages_unread_marker"
        end
      )
