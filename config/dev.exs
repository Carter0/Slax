...
config :slax, SlaxWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "uuazC+gxy9jqv82WmNgM5iAODKb9XYPJ18P97vwYp8+MSKp4WxHI5Pzo+WUnpoy1",
  watchers: [
...
config :slax, SlaxWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/slax_web/router\.ex$"E,
      ~r"lib/slax_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
